import {audioContext, restoreDuplicates, restoreCapitals} from './globals.js';
import SonicCodec from './codec.js',
...
SonicReceiver.prototype.analysePeaks = function() {
  ...
  if (this.state == State.IDLE) {
    ...
    if (char == this.coder.endChar) {
      this.state = State.IDLE;
      this.buffer = restoreDuplicates(restoreCapitals(this.buffer.split(''))).join('');
