import {audioContext, removeDuplicates, removeCapitals} from './globals.js';
...
SonicSender.prototype.send = function(input, callback) {
  ...
  removeCapitals(removeDuplicates(input.split(''))).forEach((chr, i) => {
